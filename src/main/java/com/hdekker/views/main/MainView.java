...
import com.hdekker.views.form.FormView;

/**
 * The main view is a top-level placeholder for other views.
 */
@JsModule("./styles/shared-styles.js")
@PWA(name = "AttachedDetector", shortName = "AttachedDetector",  enableInstallPrompt = false)
...
public class MainView extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "AttachedDetector logo"));
        logoLayout.add(new H1("AttachedDetector"));
